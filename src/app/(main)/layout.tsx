            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              <div className="col-span-2">
                ...
                <div className="flex space-x-4 mt-4">
                  <a href="https://www.facebook.com/anvanket1402" className="text-white-600 text-3xl hover:text-blue-500 rounded-full p-2 bg-blue-600">
                    <FaFacebookF />
                  </a>
                  <a href="https://www.instagram.com/vanket_1402/" className="text-white-600 text-3xl hover:text-blue-500 rounded-full p-2 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
                    <FaInstagram />
                  </a>
                  <a href="#" className="text-white-600 text-3xl hover:text-blue-500 rounded-full p-2 bg-blue-600">
                    <FaLinkedinIn />
                  </a>
                </div>
              </div>
          ...
          <div className="bg-white-700 pt-4">
            <div className="max-w-7xl mx-auto grid grid-cols-2 gap-4 px-4 text-center">
              ...
              <div className="text-right flex space-x-8">
                <Image src="/img/brand-threejs.svg" alt="threejs" className="inline-block w-auto" width={100} height={100} />
                <Image src="/img/Langchain--Streamline-Simple-Icons.svg" alt="langchain" className="inline-block w-auto" width={100} height={100} />
                <Image src="/img/LangGraph_icon.png" alt="langgraph" className="inline-block w-15 h-15" width={60} height={60} />
                <Image src="/img/leaflet.svg" alt="leaflet" className="inline-block w-5 h-5 mt-4" width={20} height={20} />
                <Image src="/img/mongodb-original-wordmark.svg" alt="mongodb" className="inline-block mt-3 w-8 h-8" width={32} height={32} />
                <Image src="/img/nextjs.svg" alt="nextjs" className="inline-block w-8 h-8 mt-3" width={32} height={32} />
                <Image src="/img/tailwind-css.svg" alt="tailwind" className="inline-block w-5 h-5 mt-4" width={20} height={20} />
              </div>
            </div>
          </div>
        </footer>
