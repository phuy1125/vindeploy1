            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              <div className="col-span-2">
                ...
                <div className="flex space-x-4 mt-4">
                  <a href="https://www.facebook.com/anvanket1402" className="text-white-600 text-xl hover:text-blue-500 rounded-full p-2 bg-blue-600">
                    <FaFacebookF />
                  </a>
                  <a href="https://www.instagram.com/vanket_1402/" className="text-white-600 text-xl hover:text-blue-500 rounded-full p-2 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
                    <FaInstagram />
                  </a>
                  <a href="#" className="text-white-600 text-xl hover:text-blue-500 rounded-full p-2 bg-blue-600">
                    <FaLinkedinIn />
                  </a>
                </div>
              </div>
